...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> signUp() async {
    ...
    if (passwordConfirmed()) {
      ...
      try {
        ...
        // Setelah user berhasil dibuat, tambahkan detailnya ke Firestore
        ...
        // Update display name di Firebase Auth juga (opsional tapi bagus)
  ...
  // Fungsi untuk membuat dokumen user di Firestore
  Future<void> addUserDetails(String uid, String name, String email) async {
    await FirebaseFirestore.instance.collection('users').doc(uid).set({
      ...
      'avatarUrl': null, // Bisa diisi URL default jika ada
    });
  }
